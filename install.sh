...
pacstrap /mnt base linux linux-firmware base-devel linux-headers networkmanager ufw git wget curl vim grub efibootmgr net-tools sudo base-devel man dmidecode > /dev/null
