...
pacstrap /mnt base linux linux-firmware base-devel linux-headers networkmanager git wget curl vim grub efibootmgr net-tools sudo base-devel man dmidecode > /dev/null
